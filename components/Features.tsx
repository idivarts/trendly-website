      ...
      <div className="relative h-full w-full overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-brand-50 to-white p-6">
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <div key={c.name} className="rounded-2xl border border-slate-100 bg-white p-3 shadow-sm">
      ...
      <div className="relative h-full w-full overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-accent-400/10 to-white p-6">
        <div className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm">
          ...
          <div className="mt-3 grid grid-cols-3 gap-2 text-center">
            <div className="rounded-xl bg-slate-50 p-3">
              ...
              <div className="text-[10px] uppercase tracking-wider text-slate-500">Invited</div>
            </div>
            <div className="rounded-xl bg-brand-50 p-3">
              <div className="text-lg font-extrabold text-brand-700">12</div>
              <div className="text-[10px] uppercase tracking-wider text-brand-700/80">Quoted</div>
            </div>
            <div className="rounded-xl bg-emerald-50 p-3">
              <div className="text-lg font-extrabold text-emerald-700">7</div>
              <div className="text-[10px] uppercase tracking-wider text-emerald-700/80">Hired</div>
            </div>
          </div>
        </div>
        <div className="mt-3 space-y-2">
          {[
            ...
            <div key={c.n} className="flex items-center justify-between rounded-xl border border-slate-100 bg-white p-2.5 shadow-sm">
      ...
      <div className="container-px relative">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="h-display mt-3 text-4xl sm:text-5xl">
            Everything you need, <span className="bg-gradient-brand bg-clip-text text-transparent">all in one place</span>
          </h2>
